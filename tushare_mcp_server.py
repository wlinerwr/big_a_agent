...
@mcp.tool()
async def get_stock_basic(self,exchange:str="",list_statues:str = "L") -> str:
    """
    获取上市股票基本信息（股票列表）
...
@mcp.tool()
async def get_daily_data(self,ts_code:str,start_date:str,end_date:str):
    """
    获取指定日期的历史日线
    :param ts_code 股票代码
    """
...
@mcp.tool()
async def get_financial_indicator(self,ts_code:str,period:str="20250101"):
    """获取指定股票指定日期的财务指标数据"""
    try:
